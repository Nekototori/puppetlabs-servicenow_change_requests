...
# @param [Sensitive] admin_password
...
plan servicenow_change_requests::prep_servicenow(
  ...
  $cred_result = servicenow_change_requests::make_request($cred_uri, 'get', $proxy, $admin_user, $admin_password.unwrap)
  ...
  $category_check_result = servicenow_change_requests::make_request($category_check_uri, 'get', $proxy, $admin_user, $admin_password.unwrap)
  ...
  unless $pc_choice.size == 1 {
    ...
    $new_category_result = servicenow_change_requests::make_request($new_category_uri, 'post', $proxy, $admin_user, $admin_password.unwrap, $new_category)
  ...
  $rule_check_result = servicenow_change_requests::make_request($rule_check_uri, 'get', $proxy, $admin_user, $admin_password.unwrap)
  ...
  unless $rule_check_result['body'].size == 1 {
    ...
    $new_rule_result = servicenow_change_requests::make_request($new_rule_uri, 'post', $proxy, $admin_user, $admin_password.unwrap, $new_rule)
    ...
    if $update_rule {
      ...
      $rule_result = servicenow_change_requests::make_request($rule_uri, 'patch', $proxy, $admin_user, $admin_password.unwrap, $updated_rule)
  ...
  $alias_check_result = servicenow_change_requests::make_request($alias_check_uri, 'get', $proxy, $admin_user, $admin_password.unwrap)
  ...
  unless $alias_check_result['body'].size == 1 {
    ...
    $new_alias_result = servicenow_change_requests::make_request($new_alias_uri, 'post', $proxy, $admin_user, $admin_password.unwrap, $new_alias)
  ...
  $cred_check_result = servicenow_change_requests::make_request($cred_check_uri, 'get', $proxy, $admin_user, $admin_password.unwrap)
  ...
  unless $cred_check_result['body'].size == 1 {
    ...
    $new_cred_result = servicenow_change_requests::make_request($new_cred_uri, 'post', $proxy, $admin_user, $admin_password.unwrap, $new_cred)
  ...
  $conn_check_result = servicenow_change_requests::make_request($conn_check_uri, 'get', $proxy, $admin_user, $admin_password.unwrap)
  ...
  unless $conn_check_result['body'].size == 1 {
    ...
    $new_conn_result = servicenow_change_requests::make_request($new_conn_uri, 'post', $proxy, $admin_user, $admin_password.unwrap, $new_conn)
